  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          // <li
          //   className="w-[350px] max-w-full relative rounded-2xl flex-shrink-0 px-8 py-6 md:w-[450px] border border-input bg-primary-foreground shadow-sm hover:bg-accent hover:text-accent-foreground"
          //   key={item.name}
          // >
          //   <blockquote>
          //     <div
          ...
          //     ></div>
          //     <span className=" relative z-20 text-sm leading-[1.6] text-primary font-medium">
          //       {item.quote}
          //     </span>
